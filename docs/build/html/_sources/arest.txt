...
-  `Introduction <#AssetPipeline-Introduction>`__
-  `Batch Compiler <#AssetPipeline-BatchCompiler>`__
-  `TestCompiler <#AssetPipeline-TestCompiler>`__
-  `JIT Compiler <#AssetPipeline-JITCompiler>`__
-  `Utility Classes <#AssetPipeline-UtilityClasses>`__
-  `Extending the Asset
   Pipeline <#AssetPipeline-ExtendingtheAssetPipeline>`__
-  `Asset Rules <#AssetPipeline-AssetRules>`__
...
.. rubric:: Introduction
   :name: AssetPipeline-Introduction

.. rubric:: Overview of the Asset Pipeline
   :name: AssetPipeline-OverviewoftheAssetPipeline
...
`Writing Compilers <#AssetPipeline-WritingCompilers>`__ for more
information.
...
.. rubric:: Source Assets
   :name: AssetPipeline-SourceAssets
...
the Asset Pipeline <#AssetPipeline-ExtendingtheAssetPipeline>`__ for
more information.
...
.. rubric:: Intermediate files
   :name: AssetPipeline-Intermediatefiles
...
.. rubric:: Output Location
   :name: AssetPipeline-OutputLocation
...
.. rubric:: Performance
   :name: AssetPipeline-Performance
...
`Command-Line Options <#AssetPipeline-Command-LineOptions>`__). When a
...
.. rubric:: Batch Compiler
   :name: AssetPipeline-BatchCompiler
...
.. rubric:: Configuration
   :name: AssetPipeline-Configuration

.. rubric:: Setting Up Converters
   :name: AssetPipeline-SettingUpConverters
...
.. rubric:: Setting Up Asset Rules
   :name: AssetPipeline-SettingUpAssetRules
...
rules, see `Asset Rules <#AssetPipeline-AssetRules>`__.

.. rubric:: Running the Batch Compiler
   :name: AssetPipeline-RunningtheBatchCompiler
...
.. rubric:: Command-Line Options
   :name: AssetPipeline-Command-LineOptions
...
.. rubric:: TestCompiler
   :name: AssetPipeline-TestCompiler
...
Tests <#AssetPipeline-WritingUnitTests>`__.

.. rubric:: JIT Compiler
   :name: AssetPipeline-JITCompiler

.. rubric:: Overview
   :name: AssetPipeline-Overview
...
.. rubric:: Configuration
   :name: AssetPipeline-Configuration.1

.. rubric:: Setting the Default Asset Server
   :name: AssetPipeline-SettingtheDefaultAssetServer
...
.. rubric:: Setting Up Converters
   :name: AssetPipeline-SettingUpConverters.1
...
.. rubric:: Setting Up Asset Rules
   :name: AssetPipeline-SettingUpAssetRules.1

The JIT Compiler uses asset rules to determine what files on disk are
assets, and how to convert them. For information on setting up asset
rules, see `Asset Rules <#AssetPipeline-AssetRules>`__.

.. rubric:: Asset Client Mode
   :name: AssetPipeline-AssetClientMode
...
.. rubric:: JIT Compiler Options Dialog
   :name: AssetPipeline-JITCompilerOptionsDialog
...
-  **Balloon Notifications of warnings and errors**
...
-  **Enable writing to the cache**
   Enables writing converted files to the cache.
-  **Force Rebuild of Assets**
...
.. rubric:: Viewing the Current Configuration
   :name: AssetPipeline-ViewingtheCurrentConfiguration
...
.. rubric:: Using the JIT Compiler
   :name: AssetPipeline-UsingtheJITCompiler

.. rubric:: Starting the Compiler
   :name: AssetPipeline-StartingtheCompiler
...
.. rubric:: The JIT Compiler dialog
   :name: AssetPipeline-TheJITCompilerdialog
...
***Sorting Modes***
You can select one of the following **Sort** modes to sort the list of
completed tasks.
...
.. rubric:: **To display the conversion log for an asset**
   :name: AssetPipeline-Todisplaytheconversionlogforanasset

Double-click the asset (or right-click it and select **Details**).

.. rubric:: **To open an asset in its default editing application**
   :name: AssetPipeline-Toopenanassetinitsdefaulteditingapplication

Right-click the asset and select **Open**.

.. rubric:: **To navigate to the location of an asset in Windows**
   :name: AssetPipeline-TonavigatetothelocationofanassetinWindows

Right-click it and select **Open Folder**.

.. rubric:: JIT Compiler Status Icon
   :name: AssetPipeline-JITCompilerStatusIcon
...
.. rubric:: Exiting the JIT Compiler
   :name: AssetPipeline-ExitingtheJITCompiler
...
.. rubric:: Utility Classes
   :name: AssetPipeline-UtilityClasses
...
.. rubric:: AssetServer
   :name: AssetPipeline-AssetServer
...
.. rubric:: AssetClient
   :name: AssetPipeline-AssetClient
...
.. rubric:: Extending the Asset Pipeline
   :name: AssetPipeline-ExtendingtheAssetPipeline

.. rubric:: Overview
   :name: AssetPipeline-Overview.1
...
.. rubric:: The Conversion Process
   :name: AssetPipeline-TheConversionProcess
...
.. rubric:: Recursive Conversion
   :name: AssetPipeline-RecursiveConversion
...
.. rubric:: Non-Recursive Conversion
   :name: AssetPipeline-Non-RecursiveConversion
...
.. rubric:: Writing Converters and Conversion Rules
   :name: AssetPipeline-WritingConvertersandConversionRules
...
.. rubric:: Converters
   :name: AssetPipeline-Converters.1
...
the conversion rules (see `Conversion
Rules <#AssetPipeline-ConversionRules>`__).
...
.. rubric:: Absolute vs Relative Paths
   :name: AssetPipeline-AbsolutevsRelativePaths
...
.. rubric:: Dependency List
   :name: AssetPipeline-DependencyList
...
-  ``void      addSecondaryOutputFileDependency( const BW::string & filename, bool      critical )``
   ...
   specifies the name of the compiled file to depend on, and critical
   specifies whether this is a critical dependency.
-  ``void addSecondaryDirectoryDependency(      const BW::string & directory, const BW::string & pattern, bool      recursive, bool critical )``
...
.. rubric:: Errors and Exceptions
   :name: AssetPipeline-ErrorsandExceptions
...
.. rubric:: Conversion Rules
   :name: AssetPipeline-ConversionRules
...
.. rubric:: Writing Compilers
   :name: AssetPipeline-WritingCompilers
...
.. rubric:: Asset Compiler
   :name: AssetPipeline-AssetCompiler
...
.. rubric:: Discovery Callbacks
   :name: AssetPipeline-DiscoveryCallbacks
...
.. rubric:: Task Callbacks
   :name: AssetPipeline-TaskCallbacks
...
.. rubric:: Converter Callbacks
   :name: AssetPipeline-ConverterCallbacks
...
.. rubric:: Conversion Callback
   :name: AssetPipeline-ConversionCallback
...
.. rubric:: Cache Callbacks
   :name: AssetPipeline-CacheCallbacks
...
.. rubric:: Message Callbacks
   :name: AssetPipeline-MessageCallbacks
...
.. rubric:: Registering Converters and Conversion Rules
   :name: AssetPipeline-RegisteringConvertersandConversionRules
...
.. rubric:: Initiating a Build
   :name: AssetPipeline-InitiatingaBuild
...
.. rubric:: Writing Plugins
   :name: AssetPipeline-WritingPlugins
...
.. rubric:: Plugin Loader
   :name: AssetPipeline-PluginLoader
...
.. rubric:: Converter Plugin
   :name: AssetPipeline-ConverterPlugin
...
.. rubric:: Writing Unit Tests
   :name: AssetPipeline-WritingUnitTests
...
Rules <#AssetPipeline-RegisteringConvertersandC>`__.
...
.. rubric:: Source Rules
   :name: AssetPipeline-SourceRules
...
.. rubric:: Destination Rules
   :name: AssetPipeline-DestinationRules
...
.. rubric:: Location of asset\_rules.xml
   :name: AssetPipeline-Locationofasset_rules.xml
...
.. rubric:: Excluding Files from Conversion
   :name: AssetPipeline-ExcludingFilesfromConversion
